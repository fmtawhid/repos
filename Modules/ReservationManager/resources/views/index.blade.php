...
@endsection
@section("pagetitle", localize('Manage Reservations'))

@section('breadcrumb')
@php
    $breadcrumbItems = [
        ["href"  => null, "title" => localize("Reservations List")]
    ];
@endphp
...
@section('pageTitleButtons')
    <div class="col-auto">
        <x-form.button type="button" onclick="window.location.href='{{route('reservationmanager.create')}}'">
            <i data-feather="plus" class="icon-14"></i>{{ localize('Add Reservation') }}
        </x-form.button>
    </div>
@endsection
                ...
                <div class="card">
                    <div class="card-header border-0 bg-transparent pb-0">
                        <form action="" method="get" name="searchForm" id="searchForm">
                            <div class="row g-3">                              
                                ...
                                <div class="col-auto">
                                    <x-form.button color="dark" type="button" class="btn-size-default btn btn-sm" id="searchBtn">
                    ...
                    <div class="card-body table-responsive-md">
                        <table class="table tt-footable border rounded" data-use-parent-width="true">
                            ...
                            <tbody>
                                <x-common.empty-row colspan=16 loading=true />
                            </tbody>
                        </table>
                    </div>
                </div>
