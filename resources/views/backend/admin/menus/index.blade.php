...
@endsection
@section("pagetitle", localize('Manage Menus'))

@section('breadcrumb')
    @php
        $breadcrumbItems = [
            ["href"  => null, "title" => localize("Menu List")]
        ];
    @endphp
...
@section('pageTitleButtons')
    <div class="col-auto">
        <x-form.button type="button" id="addMenuBtnForOffCanvas" data-bs-toggle="offcanvas"
                       data-bs-target="#addMenuSideBar">
            <i data-feather="plus" class="icon-14"></i>{{ localize('Add Menu') }}
        </x-form.button>
    </div>
@endsection
...
@section('content')
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header border-0 bg-transparent pb-0">
                            @include("backend.admin.menus.search-form")
                        </div>
    ...
    <!-- Add User start-->
    @include('backend.admin.menus.form-menu')
    <!-- Add User -->
...
@section('js')
    ...
    @include('backend.admin.menus.js')
