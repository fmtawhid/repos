<form action="{{ route('admin.tags.store') }}" method="POST" id="addTagForm">
    <div class="offcanvas offcanvas-end" id="addTagFormSidebar" tabindex="-1">
        @method('POST')
        @csrf
        <x-form.input name="id" id="id" type="hidden" value="" showDiv=0 />
        <div class="offcanvas-header border-bottom">
            <h5 class="offcanvas-title">{{ localize('Add Tag') }}</h5>
