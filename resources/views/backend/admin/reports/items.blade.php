...
@section('title')
    {{ localize('Items Report') }} {{ getSetting('title_separator') }} {{ getSetting('system_title') }}
@endsection
@section("pagetitle", localize('Items Report'))
@section('breadcrumb')
    @php
        $breadcrumbItems = [['href' => null, 'title' => localize('Items Report')]];
    @endphp
                                ...
                                <div class="row justify-content-between g-3">
                                    ...
                                    <div class="col-auto">
                                        <div class="input-group">
                                            ...
                                            <input class="form-control form-control-sm" type="text" name="item_name" id="item_name" placeholder="Search" value="{{ request()->get('item_name') }}">
                                        </div>
                                    </div>
                            ...
                            <table class="table border rounded">
                                <thead>
                                    <tr>
                                        ...
                                        <th>{{ localize('Item Category Name') }}</th>
                                        <th>{{ localize('Quantity Sold') }}</th>
                                        <th>{{ localize('Selling Price') }}</th>
                                        <th>{{ localize('Total Income') }}</th>
                                    </tr>
                                </thead>
                                <tbody>
