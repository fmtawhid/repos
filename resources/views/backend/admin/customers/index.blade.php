...
@section('pageTitleButtons')
    <div class="col-auto">
        <a href="{{ route('admin.customers.export') }}" class="btn btn-sm btn-soft-primary"><i
            data-feather="arrow-down" class="icon-14"></i> {{ localize('Export Customers') }}</a>
    </div>
    <div class="col-auto">
        <x-form.button type="button" id="addCustomerBtnForOffCanvas" data-bs-toggle="offcanvas"
            data-bs-target="#addCustomerSideBar"><i data-feather="plus" class="icon-14"></i>{{ localize('Add Customer') }}</x-form.button>
    </div>
@endsection
                            ...
                            <table class="table tt-footable border rounded" data-use-parent-width="true">
                                <thead>
                                    <tr class="bg-secondary-subtle">
                                        ...
                                        <th>{{ localize('F.Name') }}</th>
                                        <th>{{ localize('L.Name') }}</th>
